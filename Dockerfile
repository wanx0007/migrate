...
WORKDIR /go/src/github.com/fun/golang-migrate/migrate
...
COPY --from=builder /go/src/github.com/fun/golang-migrate/migrate/build/migrate.linux-386 /usr/local/bin/migrate
